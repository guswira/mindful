...
part of 'task_reminders_controller.dart';

// **************************************************************************
// RiverpodGenerator
// **************************************************************************

String _$taskRemindersHash() => r'e292b1a29bc8adc5dd9f93e1cdc4df2d211b13c7';
...
///
/// Copied from [taskReminders].
@ProviderFor(taskReminders)
final taskRemindersProvider = AutoDisposeFutureProvider<void>.internal(
  taskReminders,
...
typedef TaskRemindersRef = AutoDisposeFutureProviderRef<void>;
